  ...
  return (
    <div className="min-h-screen flex w-full bg-white selection:bg-zinc-900 selection:text-white">
      <div className="hidden lg:flex w-1/2 relative bg-zinc-950 flex-col justify-between p-12 lg:p-24 overflow-hidden">
        <div className="absolute inset-0 z-0 opacity-20" style={{ backgroundImage: 'radial-gradient(#ffffff 1px, transparent 1px)', backgroundSize: '32px 32px' }} />
        <div className="relative z-10 flex items-center gap-3">
          <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center shadow-lg">
            <div className="w-4 h-4 bg-zinc-950 rounded-sm" />
          </div>
          <span className="text-white font-bold text-xl tracking-tight">Admin Platform</span>
        </div>
        <div className="relative z-10">
          <h1 className="text-5xl lg:text-7xl font-bold text-white tracking-tighter leading-[1.05] mb-6">
            Build faster.<br />Scale further.
          </h1>
          <p className="text-xl text-zinc-400 font-light max-w-md leading-relaxed">
            The ultimate dashboard for managing your infrastructure, analyzing metrics, and accelerating growth securely.
          </p>
        </div>
        <div className="relative z-10 text-zinc-500 text-sm font-medium">
          &copy; {new Date().getFullYear()} Admin Platform Inc.
        </div>
      </div>
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 lg:p-24 relative bg-white">
        <div className="w-full max-w-[420px] space-y-8 relative z-10">
          <div className="lg:hidden flex items-center gap-3 mb-10">
            ...
            <span className="text-zinc-950 font-bold text-xl tracking-tight">Admin Platform</span>
          </div>
          <div className="text-left mb-8">
            <Typography.Title level={2} className="!mb-2 !font-bold !text-zinc-950 !text-3xl tracking-tight">
              Welcome back
            </Typography.Title>
          ...
          <div className="mt-8 text-center text-sm text-zinc-500">
            ...
            <a href="#" className="font-semibold text-zinc-950 hover:text-zinc-700 transition-colors hover:underline underline-offset-4">
              Request access
            </a>
          </div>
        </div>
